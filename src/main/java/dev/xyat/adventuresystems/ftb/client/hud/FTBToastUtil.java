...
public final class FTBToastUtil {
    private static final KineticOverlays.Position POSITION = KineticOverlays.Position.BOTTOM_CENTER;
    ...
    public static void show(String id, Component message) {
        KineticOverlays.toast(id, message);
    }
    ...
    public static void showTimed(String id, Component message, int durationMs) {
        KineticOverlays.toast(id, message, POSITION, durationMs, OFFSET_X, OFFSET_Y);
    }
}
